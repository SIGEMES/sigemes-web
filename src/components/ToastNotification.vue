  ...
  <div :class="['toast-notification', type]" v-if="visible">
    <div class="icon-container">
      ...
      <template v-else-if="type === 'warning'">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
          <path fill-rule="evenodd" d="M9.401 3.003c1.155-1.156 3.043-1.156 4.198 0l7.355 7.354a2.967 2.967 0 0 1 0 4.199l-7.355 7.354c-1.155 1.156-3.043 1.156-4.198 0L2.046 14.556a2.967 2.967 0 0 1 0-4.199L9.4 3.003ZM12 8.25a.75.75 0 0 1 .75.75v3.75a.75.75 0 0 1-1.5 0V9a.75.75 0 0 1 .75-.75Zm0 8.25a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z" clip-rule="evenodd" />
        </svg>
      </template>
...
export default {
  props: {
    ...
    duration: {
      type: Number,
      default: 2800, // Durasi default 2.8 detik
    },
  },
  data() {
    return {
