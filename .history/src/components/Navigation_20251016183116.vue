...
export default {
  ...
  setup() {
    ...
    const { userFullname, isSuperAdmin } = storeToRefs(authStore);
    ...
    return { route, router, dropdownOpen, toggleDropdown, logout, isSuperAdmin, userFullname, isSuperAdmin, userFullname, userRole};
  }
};
</script>
