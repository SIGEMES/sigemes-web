            ...
            <div class="space-y-4">
              ...
              <div class="flex space-x-4">
                <div class="w-1/2">
                  ...
                  <input
                    ...
                    @input="validateNumberOnly($event, 'area_m2', 'cityhall')"
                  />
                </div>
                <div class="w-1/2">
                  ...
                  <input
                    ...
                    @input="validateNumberOnly($event, 'people_capacity', 'cityhall')"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  @input="validateNumberOnly($event, 'contact_person', 'cityhall')"
                />
              </div>
                  ...
                  <div class="space-y-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        :value="getFormattedPrice(price.price_per_day)"
                        @input="formatPriceInput($event, 'price_per_day', 'pricing', index)"
                      />
                    </div>
...
export default {
  ...
  methods: {
    ...
    validateNumberOnly(event, field, type, index = null) {
      console.log('🔍 validateNumberOnly called:', field, type, event.target.value)
      // Get input value
      ...
      // Prevent leading zeros (kecuali input adalah "0" saja)
      ...
      if (type === 'cityhall') {
        if (this.showCreateModal) {
          this.newCityHall[field] = value
        } else if (this.showEditModal) {
          this.editCityHall[field] = value
        }
      } else if (type === 'pricing' && index !== null) {
        if (this.showCreateModal) {
          this.newCityHall.pricing[index][field] = value
        } else if (this.showEditModal) {
          this.editCityHall.pricing[index][field] = value
        }
      }
    ...
    formatPriceInput(event, field, type, index = null) {
      console.log('💰 formatPriceInput called:', field, type, index, event.target.value)
      // Get input value
      let value = event.target.value
      ...
      if (type === 'pricing' && index !== null) {
        if (this.showCreateModal) {
          this.newCityHall.pricing[index][field] = numericValue
        } else if (this.showEditModal) {
          this.editCityHall.pricing[index][field] = numericValue
        }
      }
      ...
      if (numericValue) {
        ...
        console.log('✅ Formatted price:', formatted, 'Raw value:', numericValue)
      } else {
        event.target.value = ''
      }
    },
