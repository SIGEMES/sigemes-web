            ...
            >
              ...
              <td class="py-2 px-4 border">
                <div class="flex justify-evenly w-full data-admin-text">
                  <button @click="openEditModal(admin)" class="text-blue-500 font-black">Edit</button>
                  <button @click="openDeleteModal(admin)" class="text-red-500 font-black">Hapus</button>
                </div>
              </td>
            </tr>
          </transition-group>
      ...
      >
        ...
        >
          ...
          <div class="flex justify-center space-x-4">
            <button
              @click="deleteAdmin"
              class="data-admin-text font-black bg-red-500 text-white px-5 py-2 rounded-lg hover:bg-red-700 flex items-center justify-center"
              :disabled="isDeletingAdmin"
            >
              <svg
                v-if="isDeletingAdmin"
                class="animate-spin h-5 w-5 mr-2 text-white font-black"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
              >
              ...
              <span class="font-black">{{ isDeletingAdmin ? 'Menghapus...' : 'Hapus' }}</span>
            </button>
            <button
