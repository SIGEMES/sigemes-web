                    ...
                    <div>
                      ...
                      <div class="flex">
                        ...
                        <button
                          ...
                          class="bg-blue-500 text-white px-2 py-1.5 rounded-r-lg hover:bg-blue-600 font-semibold data-gedung-text text-sm"
                        >
                          + Tambah
                        </button>
                      </div>
                    ...
                    <div>
                      ...
                      <div class="flex">
                        ...
                        <button
                          ...
                          class="bg-blue-500 text-white px-3 py-1.5 rounded-r-lg hover:bg-blue-600 font-semibold data-gedung-text text-sm"
                        >
                          + Tambah
                        </button>
                      </div>
