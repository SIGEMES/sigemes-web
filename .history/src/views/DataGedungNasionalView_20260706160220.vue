        ...
        >
          ...
          <div class="flex justify-center space-x-4 mt-8">
            <button
              ...
              class="font-bold bg-red-500 text-white px-6 py-2 rounded-lg hover:bg-red-600 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center min-w-[120px]"
            >
              <svg
          ...
          <form @submit.prevent="submitCreateForm">
            ...
            <div class="space-y-4">
              ...
              <div class="flex space-x-4">
                <div class="w-1/2">
                  ...
                  <input
                    ...
                    @input="preventLeadingZero($event, 'area_m2'); clearAreaError()"
                  />
                ...
                <div class="w-1/2">
                  ...
                  <input
                    ...
                    @input="preventLeadingZero($event, 'people_capacity'); clearCapacityError()"
                  />
              ...
              <div>
                ...
                />
                <p v-if="contactError" class="text-red-500 text-sm mt-1">
                  {{ contactError }}
                </p>
              </div>
              ...
              <div>
                ...
                <div class="mb-2">
                  <div class="flex">
                    <input
                      v-model="searchQuery"
                      type="text"
                      placeholder="Ketikkan lokasi atau pilih dari peta. Gunakan hanya untuk mencari tempat, kosongi jika tidak perlu."
                      ...
                      :class="{ 'border-red-500': coordinateError }"
                ...
                <p v-if="coordinateError" class="text-red-500 text-sm mt-1">
                  {{ coordinateError }}
                </p>
              </div>
                  ...
                  <div class="space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        required
                        class="w-full px-3 py-2 border text-black rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        :class="{ 'border-red-500': pricingErrors[index]?.activityType }"
                        placeholder="Contoh: Komersial, Sosial, dll."
                        @input="clearPricingError(index, 'activityType')"
                      />
                      <p
                        v-if="pricingErrors[index]?.activityType"
                        class="text-red-500 text-sm mt-1"
                      >
                        {{ pricingErrors[index].activityType }}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                        class="w-full px-3 py-2 border text-black rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        :class="{ 'border-red-500': pricingErrors[index]?.pricePerDay }"
                        placeholder="Contoh: 500.000"
                        :value="formatRupiah(price.price_per_day)"
                        @input="handlePriceInput($event, index); clearPricingError(index, 'pricePerDay')"
                      />
                      <p v-if="pricingErrors[index]?.pricePerDay" class="text-red-500 text-sm mt-1">
                        {{ pricingErrors[index].pricePerDay }}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <div class="flex">
                        ...
                        <button
                          ...
                          class="bg-blue-500 text-white px-2 py-1 rounded-r-lg hover:bg-blue-600 font-semibold data-gedung-text text-sm whitespace-nowrap"
                        >
                          + Tambah
                        </button>
                      </div>
                    ...
                    <p v-if="pricingErrors[index]?.facilities" class="text-red-500 text-sm mt-1">
                      {{ pricingErrors[index].facilities }}
                    </p>
                  </div>
                </div>
        ...
        >
          ...
          <form @submit.prevent="submitEditForm">
            ...
            <div class="space-y-4">
              <!-- Nama Gedung -->
              <div>
                <label for="editBuildingName" class="block text-black data-gedung-text font-bold mb-1"
                  >Nama Gedung</label
                >
                <input
                  id="editBuildingName"
              ...
              <!-- Alamat -->
              <div>
                <label for="editAddress" class="block text-black data-gedung-text font-bold mb-1">Alamat</label>
                <input
                  id="editAddress"
              ...
              <!-- Tentang Gedung (deskripsi) -->
              <div>
                <label for="editDescription" class="block text-black data-gedung-text font-bold mb-1"
                  >Tentang Gedung</label
                >
                <textarea
                  id="editDescription"
              ...
              <div class="flex space-x-4">
                <div class="w-1/2">
                  <label for="editArea" class="block text-black data-gedung-text font-bold mb-1"
                    >Luas Bangunan (m²)</label
                  >
                  <input
                    id="editArea"
                    ...
                    :class="{ 'border-red-500': areaMError }"
                    placeholder="Contoh: 250"
                    @input="preventEditLeadingZero($event, 'area_m2'); clearAreaError()"
                  />
                  <p v-if="areaMError" class="text-red-500 text-sm mt-1">
                    {{ areaMError }}
                  </p>
                ...
                <div class="w-1/2">
                  <label for="editCapacity" class="block text-black data-gedung-text font-bold mb-1"
                    >Kapasitas Orang</label
                  >
                  <input
                    id="editCapacity"
                    ...
                    :class="{ 'border-red-500': capacityError }"
                    placeholder="Contoh: 100"
                    @input="preventEditLeadingZero($event, 'people_capacity'); clearCapacityError()"
                  />
                  <p v-if="capacityError" class="text-red-500 text-sm mt-1">
                    {{ capacityError }}
                  </p>
              ...
              <!-- Contact Person -->
              <div>
                <label for="editContactPerson" class="block text-black data-gedung-text font-bold mb-1"
                  >Contact Person</label
                >
                <input
              ...
              <!-- Koordinat Maps -->
              <div>
                <label class="block text-black data-gedung-text font-bold mb-2">Koordinat Maps</label>
                <div class="mb-2">
                  <div class="flex">
                    <input
                      ...
                      class="w-full px-3 py-2 border text-black rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                      :class="{ 'border-red-500': coordinateError }"
              ...
              <!-- Kategori Sewa -->
              <div>
                <label class="block text-black data-gedung-text font-bold mb-2">Kategori Sewa</label>
                  ...
                  <div class="space-y-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Contoh: 500.000"
                        :value="formatRupiah(price.price_per_day)"
                        @input="handleEditPriceInput($event, index); clearPricingError(index, 'pricePerDay')"
                      />
                      <p v-if="pricingErrors[index]?.pricePerDay" class="text-red-500 text-sm mt-1">
                        {{ pricingErrors[index].pricePerDay }}
                      </p>
...
export default {
  ...
  methods: {
    ...
    // Clear validation errors when user inputs valid data
    ...
    clearAddressError() {
      const address = this.showCreateModal ? this.newCityHall.address : this.editCityHall.address
    ...
    clearAreaError() {
      const area = this.showCreateModal ? this.newCityHall.area_m2 : this.editCityHall.area_m2
    ...
    clearCapacityError() {
      const capacity = this.showCreateModal
    ...
    clearContactError() {
      const contact = this.showCreateModal
        ? this.newCityHall.contact_person
        : this.editCityHall.contact_person
    ...
    clearCoordinateError() {
      const latitude = this.showCreateModal ? this.newCityHall.latitude : this.editCityHall.latitude
      const longitude = this.showCreateModal
        ? this.newCityHall.longitude
        : this.editCityHall.longitude
      if (latitude && longitude) {
        this.coordinateError = ''
      }
    },

    clearPricingError(index, field) {
      if (!this.pricingErrors[index]) return

      const pricing = this.showCreateModal
        ? this.newCityHall.pricing[index]
        : this.editCityHall.pricing[index]

      if (field === 'activityType' && pricing.activity_type && pricing.activity_type.trim()) {
        this.pricingErrors[index].activityType = ''
      } else if (
        field === 'pricePerDay' &&
        ...
        this.pricingErrors[index].pricePerDay = ''
      } else if (field === 'facilities' && pricing.facilities && pricing.facilities.trim()) {
        this.pricingErrors[index].facilities = ''
      }
    },
    ...
    async searchLocation() {
      ...
      try {
        ...
        if (response.data && response.data.length > 0) {
          ...
          // Clear coordinate error when location is found
    ...
    createMap() {
      ...
      this.map.on('click', (e) => {
        ...
        // Clear coordinate error when location is selected
        this.clearCoordinateError()
      })
    ...
    addFacility(index) {
      ...
      // Clear error for facilities
      this.clearPricingError(index, 'facilities')
    },
    ...
    validateForm() {
      ...
      if (
        ...
        if (isValid)
          this.showToast('warning', 'Silakan isi kapasitas orang dengan angka yang valid')
        isValid = false
      }
      ...
      this.newCityHall.pricing.forEach((price, index) => {
        ...
        if (!price.activity_type || !price.activity_type.trim()) {
          ...
          if (isValid)
            this.showToast('warning', 'Silakan isi jenis kegiatan pada semua kategori sewa')
          isValid = false
        }
        ...
        if (!price.price_per_day || price.price_per_day === '0' || price.price_per_day === 0) {
          ...
          if (isValid)
            this.showToast('warning', 'Silakan isi harga sewa per hari pada semua kategori')
          isValid = false
        }
        ...
        if (!price.facilities || !price.facilities.trim()) {
          ...
          if (isValid)
            this.showToast(
              'warning',
              'Silakan tambahkan minimal satu fasilitas pada semua kategori sewa',
            )
          isValid = false
        }
