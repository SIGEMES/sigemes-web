  ...
  <div>
    ...
    <div class="container mt-6 mx-auto px-6 py-8">
      ...
      <transition name="welcome-fade">
        <h1 v-if="showWelcome" class="rent-column text-xl md:text-2xl font-black text-black mb-8">
          Selamat datang di sistem informasi gedung nasional dan gedung mess, {{ fullname }}!
        </h1>
      </transition>
...
export default {
  ...
  methods: {
    ...
    async fetchRentals() {
      ...
      try {
        ...
        // fetch semua rental menggunakan fungsi apiService.js
  ...
  mounted() {
    // Ambil fullname dari localStorage atau set default jika belum ada
    this.fullname = localStorage.getItem('fullname') || '[Nama User]';
