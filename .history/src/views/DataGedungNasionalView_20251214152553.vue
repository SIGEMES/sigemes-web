                ...
                >
                  ...
                  <div class="space-y-3">
                    <div>
                      ...
                      />
                      <p v-if="pricingErrors[index]?.activityType" class="text-red-500 text-sm mt-1">
...
export default {
  ...
  methods: {
    ...
    clearAddressError() {
      const address = this.showCreateModal
        ? this.newCityHall.address
        : this.editCityHall.address
    ...
    clearAreaError() {
      const area = this.showCreateModal
    ...
    clearCoordinateError() {
      const latitude = this.showCreateModal
        ? this.newCityHall.latitude
        : this.editCityHall.latitude
    ...
    clearPricingError(index, field) {
      ...
      } else if (field === 'pricePerDay' && pricing.price_per_day && pricing.price_per_day !== '0' && pricing.price_per_day !== 0) {
