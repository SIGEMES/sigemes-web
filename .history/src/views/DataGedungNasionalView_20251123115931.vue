          ...
          <form @submit.prevent="submitCreateForm">
            ...
            <div class="space-y-4">
              ...
              <div class="flex space-x-4">
                ...
                <div class="w-1/2">
                  <label for="capacity" class="block font-semibold text-black"
              ...
              <!-- Contact Person -->
              <div>
                <label for="contactPerson" class="block font-semibold text-black"
              ...
              <div>
                ...
                <div class="flex space-x-4 mt-2">
                  <div class="hidden">
                    <input id="latitude" v-model="newCityHall.latitude" type="text" required />
                    <input id="longitude" v-model="newCityHall.longitude" type="text" required />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <div class="space-y-3">
                    <div>
                      <label :for="`category-${index}`" class="block text-sm text-gray-600"
                    ...
                    <div>
                      <label :for="`price-${index}`" class="block text-sm text-gray-600"
                    ...
                    <div>
                      <label :for="`facilities-${index}`" class="block text-sm text-gray-600"
                        >Fasilitas</label
                      >
                      <div class="flex">
                        <input
...
export default {
  ...
  methods: {
    ...
    async updateReply(rentId, reviewId, replyId) {
      ...
      try {
        // update reply menggunakan fungsi apiService.js
        const response = await apiService.updateReviewReply(rentId, reviewId, replyId, {
    ...
    validateForm() {
      ...
      if (this.uploadedPhotos.length === 0) {
        this.showToast('warning', 'Harap upload minimal satu foto gedung!')
        return false
      }

      // Check if coordinates are selected
      if (!this.newCityHall.latitude || !this.newCityHall.longitude) {
        this.showToast('warning', 'Harap pilih lokasi gedung pada peta!')
        return false
      }
      ...
      for (const price of this.newCityHall.pricing) {
        if (!price.activity_type || !price.price_per_day || !price.facilities) {
          this.showToast('warning', 'Harap lengkapi data kategori sewa!')
          return false
        }
      }
