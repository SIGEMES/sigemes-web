              ...
              <div class="flex space-x-4">
                <div class="w-1/2">
                  ...
                  <input
                    ...
                    @input="
                      preventLeadingZero($event, 'area_m2')
                      clearAreaError()
                    "
                  />
                ...
                <div class="w-1/2">
                  ...
                  <input
                    ...
                    @input="
                      preventLeadingZero($event, 'people_capacity')
                      clearCapacityError()
                    "
                  />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        @input="
                          ...
                          clearPricingError(index, 'pricePerDay')
                        "
                      />
        ...
        >
          ...
          <form @submit.prevent="submitEditForm">
            ...
            <div class="space-y-4">
              ...
              <!-- Alamat -->
              <div>
                <label for="editAddress" class="block text-black data-gedung-text font-bold mb-1"
                  >Alamat</label
                >
                <input
                  id="editAddress"
              ...
              <div class="flex space-x-4">
                <div class="w-1/2">
                  ...
                  <input
                    ...
                    placeholder="Contoh: 250"
                    @input="
                      preventEditLeadingZero($event, 'area_m2')
                      clearAreaError()
                    "
                  />
                  <p v-if="areaMError" class="text-red-500 text-sm mt-1">
                ...
                <div class="w-1/2">
                  ...
                  <input
                    ...
                    placeholder="Contoh: 100"
                    @input="
                      preventEditLeadingZero($event, 'people_capacity')
                      clearCapacityError()
                    "
                  />
                  <p v-if="capacityError" class="text-red-500 text-sm mt-1">
