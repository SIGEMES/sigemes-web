  ...
  <div>
          ...
          <form @submit.prevent="submitEditForm">
            ...
            <div class="mb-6">
              ...
              <div
                ...
                class="relative w-full h-64 bg-gray-100 rounded-lg flex items-center justify-center mb-2 cursor-pointer hover:bg-gray-200 transition-colors"
                @click="$refs.editPhotoUploadInput.click()"
              >
                <div class="text-center">
                  <div
                    class="w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center mx-auto mb-3"
              ...
              <div v-else class="relative">
                ...
                <div class="relative w-full mb-4">
                  <img
                    ...
                    @click="openEditPhotoSlideshow(currentEditPhotoIndex)"
                    class="w-full h-64 object-contain rounded-lg cursor-pointer hover:opacity-90 transition-opacity"
                    alt="Preview"
                  />
                ...
                <div class="flex items-center space-x-2 overflow-x-auto pb-2">
                  <div
                    ...
                    :key="index"
                    @click="currentEditPhotoIndex = index"
                    class="relative flex-shrink-0 cursor-pointer"
                    :class="[
                      currentEditPhotoIndex === index
                        ? 'ring-4 ring-blue-500 rounded-lg'
                        : 'opacity-60 hover:opacity-100',
                    ]"
                  >
    ...
    <transition name="modal">
      <div
        ...
        class="photo-slideshow fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center"
        style="z-index: 9999"
      >
