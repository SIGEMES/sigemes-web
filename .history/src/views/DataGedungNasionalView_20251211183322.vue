            ...
            <div class="space-y-4">
              ...
              <div class="flex space-x-4">
                <div class="w-1/2">
                  ...
                  <input
                    id="area"
                    v-model.number="newCityHall.area_m2"
                    type="number"
                    min="1"
                    required
                    class="w-full px-3 py-2 border text-black rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div class="w-1/2">
                  ...
                  <input
                    id="capacity"
                    v-model.number="newCityHall.people_capacity"
                    type="number"
                    min="1"
                    required
                    class="w-full px-3 py-2 border text-black rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                ...
                >
                  ...
                  <div class="space-y-3">
                    <div>
                      <label :for="`category-${index}`" class="block text-black data-gedung-text font-bold mb-1"
                    ...
                    <div>
                      <label :for="`price-${index}`" class="block text-black data-gedung-text font-bold mb-1"
                    ...
                    <div>
                      <label :for="`facilities-${index}`" class="block text-black data-gedung-text font-bold mb-1"
                        >Fasilitas</label
                      >
                      <div class="flex">
                        <input
...
export default {
  ...
  methods: {
    ...
    validateForm() {
      ...
      if (!this.newCityHall.area_m2 || this.newCityHall.area_m2 === '0' || this.newCityHall.area_m2 === 0) {
        this.showToast('warning', 'Silakan isi luas bangunan dengan angka yang valid')
        return false
      }

      if (!this.newCityHall.people_capacity || this.newCityHall.people_capacity === '0' || this.newCityHall.people_capacity === 0) {
      ...
      for (const price of this.newCityHall.pricing) {
        ...
        if (!price.facilities || !price.facilities.trim()) {
          this.showToast('warning', 'Silakan tambahkan minimal satu fasilitas pada semua kategori sewa')
          return false
        }
      }
    ...
    validateEditForm() {
      ...
      // Validate numeric fields
      if (!this.editCityHall.area_m2 || this.editCityHall.area_m2 === '0' || this.editCityHall.area_m2 === 0) {
        this.showToast('warning', 'Silakan isi luas bangunan dengan angka yang valid')
        return false
      }

      if (!this.editCityHall.people_capacity || this.editCityHall.people_capacity === '0' || this.editCityHall.people_capacity === 0) {
        this.showToast('warning', 'Silakan isi kapasitas orang dengan angka yang valid')
        return false
      }
