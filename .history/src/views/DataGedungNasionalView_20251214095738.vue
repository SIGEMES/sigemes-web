  ...
  <div>
      ...
      >
        ...
        >
          ...
          <form @submit.prevent="submitCreateForm">
            ...
            <div class="mb-6">
              <!-- Empty State: Tampilkan saat belum ada foto -->
              <div
                v-if="uploadedPhotos.length === 0"
                class="relative w-full h-64 bg-gray-100 rounded-lg flex items-center justify-center mb-2 cursor-pointer hover:bg-gray-200 transition-colors"
                @click="$refs.photoUploadInput.click()"
              >
                <div class="text-center">
                  <div
                    class="w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center mx-auto mb-3"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div class="text-black font-bold data-gedung-text text-lg">Tambah Foto</div>
                  <div class="text-gray-500 text-sm mt-1">Klik untuk upload foto gedung</div>
                </div>
              </div>

              <!-- Preview State: Tampilkan saat sudah ada foto -->
              <div v-else class="relative">
                <!-- Main Photo Display -->
                <div class="relative w-full mb-4">
                  <img
                    :src="uploadedPhotos[currentPhotoIndex].preview"
                    @click="openCreatePhotoSlideshow(currentPhotoIndex)"
                  ...
                  <!-- Photo Counter -->
                  <div
                    class="absolute bottom-3 left-1/2 transform -translate-x-1/2 bg-black bg-opacity-60 text-white px-4 py-1.5 rounded-full text-sm font-medium"
                  >
                  ...
                  <button
                    ...
                    class="absolute top-3 right-3 bg-red-500 hover:bg-red-600 text-white rounded-full p-2 transition-colors shadow-lg"
                  ...
                  <button
                    ...
                    type="button"
                    @click="prevPhoto"
                    class="absolute left-3 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-75 hover:bg-opacity-100 text-black rounded-full p-2 transition-all shadow-lg"
                  ...
                  <button
                    ...
                    type="button"
                    @click="nextPhoto"
                    class="absolute right-3 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-75 hover:bg-opacity-100 text-black rounded-full p-2 transition-all shadow-lg"
                ...
                <div class="flex items-center space-x-2 overflow-x-auto pb-2">
                  ...
                  >
                    <img
                      :src="photo.preview"
                      class="w-20 h-20 object-cover rounded-lg transition-all"
                      alt="Thumbnail"
                    />
                  </div>
                  ...
                  <div
                    @click="$refs.photoUploadInput.click()"
                    class="flex-shrink-0 w-20 h-20 bg-gray-100 hover:bg-gray-200 rounded-lg flex items-center justify-center cursor-pointer transition-colors"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <form @submit.prevent="submitEditForm">
            ...
            <div class="mb-6">
              ...
              <div v-if="editedPhotos.length > 0" class="relative mb-4">
                <div class="relative w-full flex justify-center">
                  ...
                  <div class="w-full h-64 relative">
                    ...
                    <div
                      class="absolute bottom-2 left-1/2 transform -translate-x-1/2 bg-black bg-opacity-50 text-white px-3 py-1 rounded-full text-sm"
                    >
                ...
                <button
                  ...
                  :class="{
                    'opacity-50 cursor-not-allowed':
                      currentEditPhotoIndex === editedPhotos.length - 1,
                  }"
                >
                  ▶
                </button>
              ...
              <div class="flex justify-center">
                <label
                  for="photoEditUpload"
                  class="cursor-pointer bg-white p-4 rounded-lg shadow-lg flex flex-col items-center"
                >
                  <div class="mb-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span class="data-gedung-text text-black font-semibold text-center"
                    >Tambah Foto</span
                  >
                  <input
                    id="photoEditUpload"
    ...
    <transition name="modal">
      <div
        ...
        class="photo-slideshow fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50"
      >
        <div class="relative w-full max-w-4xl px-16">
          <div class="relative w-full flex justify-center">
            <div class="relative max-w-3xl">
              ...
              <button
                ...
                class="absolute top-2 right-2 bg-black bg-opacity-50 text-white hover:text-gray-200 p-2 rounded-full"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-6 w-6"
